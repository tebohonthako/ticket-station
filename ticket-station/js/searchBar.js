...
let durbanJazzConcert = new MusicEvent("Durban Jazz Concert", "-12 Jun8e", 499.99, "images/maxresdefault (1).jpg", "durbanJazzConcert", '2023-06-08');
...
const eventsContainer = document.querySelector('#popularEvents');

let popularEvents =[johannesburgMusicFestival, capeTownMusicFestival,johannesburgJazzConcert, capeTownJazzConcert, johannesburgRockConcert, capeTownrockConcert];
...
select.addEventListener('change', function() {
 ...
 // Display search results
 const results = performSearch(selectedEvent); // replace with your own search logic
 results.forEach(function(result) {
...
nameSelect.addEventListener('change', function() {
 ...
 // Display search results
 const results = performSearch(selectedOption) // replace with your own search logic
 results.forEach(function(result) {
